...
<body>
            ...
            <div class="events-grid">
                <div class="event-card">
                    ...
                    <div class="event-image">
                        <img src="/images/smile3.jpg" alt="World Blood Donor Day event" />
                    ...
                    <div class="event-content">
                        <h3 class="event-title">World Blood Donor Day Special Drive</h3>
                        <div class="event-location">
                            <i class="fas fa-map-marker-alt"></i>
                            <span>City Central Hospital, Main Auditorium</span>
                        </div>
                        <p class="event-description">Join us for our biggest blood drive of the year as we celebrate World Blood Donor Day. Free health checkups and refreshments for all donors.</p>
                ...
                <div class="event-card">
                    <div class="event-image">
                        <img src="/images/emily.jpg" alt="College Campus Blood Drive" />
                        <div class="event-date-badge">
                    ...
                    <div class="event-content">
                        <h3 class="event-title">College Campus Blood Drive</h3>
                        <div class="event-location">
                            <i class="fas fa-map-marker-alt"></i>
                            <span>State University, Student Union Building</span>
                        </div>
                        <p class="event-description">Calling all students! Donate blood between classes and receive community service hours. Student ID required for special gifts.</p>
                        <div class="event-footer">
                            <div class="event-time">
                                <i class="far fa-clock"></i>
   ...
   <div class="event-card">
       ...
       <div class="event-content">
        ...
        <div class="featured-tag">Featured</div>
        <div class="event-image">
            <img src="/images/p1.jpeg" alt="World Blood Donor Day event" />
            <div class="event-date-badge">
                <span class="event-date-day">14</span>
                <span class="event-date-month">Jun</span>
            </div>
        ...
        <div class="event-content">
            <h3 class="event-title">Heroes Blood Drive</h3>
            <div class="event-location">
                <i class="fas fa-map-marker-alt"></i>
                <span>City General Hospital, Health Pavilion</span>
            </div>
            <p class="event-description">Celebrate the heroes who save lives every day by donating blood. Free wellness checkups and refreshments for all donors.</p>
            <div class="event-footer">
                <div class="event-time">
                    <i class="far fa-clock"></i>
    ...
    <div class="event-card">
        <div class="event-image">
            <img src="/images/p2.jpg" alt="College Campus Blood Drive" />
            <div class="event-date-badge">
        ...
        <div class="event-content">
            <h3 class="event-title">University Blood Awareness Camp</h3>
            <div class="event-location">
                <i class="fas fa-map-marker-alt"></i>
                <span>Greenwood University, Main Hall</span>
            </div>
            <p class="event-description">Encouraging students and faculty to give back to the community through blood donation. Special recognition for first-time donors.</p>
            <div class="event-footer">
                <div class="event-time">
                    <i class="far fa-clock"></i>
    ...
    <div class="event-card">
        <div class="event-image">
            <img src="/images/p3.jpg" alt="Corporate Challenge Blood Drive" />
            <div class="event-date-badge">
                <span class="event-date-day">05</span>
                <span class="event-date-month">Jul</span>
            </div>
        ...
        <div class="event-content">
            <h3 class="event-title">Tech Giants Blood Drive</h3>
            <div class="event-location">
                <i class="fas fa-map-marker-alt"></i>
                <span>Cyber Hub, Innovation Center</span>
            </div>
            <p class="event-description">A competitive blood donation drive among leading tech companies. Winning team gets a corporate donation to the charity of their choice.</p>
            <div class="event-footer">
                <div class="event-time">
                    <i class="far fa-clock"></i>
                    <span>8:00 AM - 5:00 PM</span>
    ...
    <div class="event-card">
        <div class="event-image">
            <img src="/images/p5.jpg" alt="Mobile Blood Drive" />
            <div class="event-date-badge">
        ...
        <div class="event-content">
            <h3 class="event-title">Neighborhood Mobile Blood Drive</h3>
            <div class="event-location">
                <i class="fas fa-map-marker-alt"></i>
                <span>Westside Community Park, Mobile Unit</span>
            </div>
            <p class="event-description">Our bloodmobile is coming to your neighborhood! Quick and convenient donation process with no appointment necessary. Walk-ins welcome.</p>
            <div class="event-footer">
                <div class="event-time">
                    <i class="far fa-clock"></i>
    ...
    <div class="event-card">
        <div class="event-image">
            <img src="/images/p4.jpg" alt="Faith-Based Blood Drive" />
            <div class="event-date-badge">
        ...
        <div class="event-content">
            <h3 class="event-title">Faith Community Blood Drive</h3>
            <div class="event-location">
                <i class="fas fa-map-marker-alt"></i>
                <span>Grace Community Church, Fellowship Hall</span>
            </div>
            <p class="event-description">Our annual interfaith blood drive brings communities together to save lives. Family-friendly event with activities for children while parents donate.</p>
            <div class="event-footer">
                <div class="event-time">
                    <i class="far fa-clock"></i>
    ...
    <div class="event-card">
        <div class="event-image">
            <img src="/images/blood4.jpg" alt="First Responders Blood Drive" />
            <div class="event-date-badge">
        ...
        <div class="event-content">
            <h3 class="event-title">First Responders Appreciation Drive</h3>
            <div class="event-location">
                <i class="fas fa-map-marker-alt"></i>
                <span>Main Fire Station, Training Room</span>
            </div>
            <p class="event-description">Honoring those who serve our community. Special event for first responders and their families, though all donors are welcome. Tour the station after donating!</p>
            <div class="event-footer">
                <div class="event-time">
                    <i class="far fa-clock"></i>
                    <span>10:00 AM - 6:00 PM</span>
   ...
   <div class="event-card">
       <div class="event-image">
           <img src="/images/blood8.jpg" alt="Southern Hospitality Blood Drive" />
           <div class="event-date-badge">
       ...
       <div class="event-content">
           ...
           <div class="event-footer">
               ...
               <a href="RegisterNow.aspx" class="event-signup">Register Now</a>
                ...
                <div class="event-card">
                    <div class="event-image">
                        <img src="/images/blooddonation.jpg" alt="Corporate Challenge Blood Drive" />
                        <div class="event-date-badge">
                            <span class="event-date-day">05</span>
                            <span class="event-date-month">Jun</span>
                        </div>
                    ...
                    <div class="event-content">
                        <h3 class="event-title">Corporate Challenge Blood Drive</h3>
                        <div class="event-location">
                            <i class="fas fa-map-marker-alt"></i>
                            <span>Downtown Business Center, Conference Room A</span>
                        </div>
                        <p class="event-description">Companies compete to see who can donate the most blood. Winning team receives recognition and a catered lunch. All participants receive time off.</p>
                        <div class="event-footer">
                            <div class="event-time">
                                <i class="far fa-clock"></i>
                                <span>8:00 AM - 5:00 PM</span>
                ...
                <div class="event-card">
                    <div class="event-image">
                        <img src="/images/blood8.jpg" alt="Mobile Blood Drive" />
                        <div class="event-date-badge">
                            <span class="event-date-day">17</span>
                            <span class="event-date-month">May</span>
                        </div>
                ...
                <div class="event-card">
                    <div class="event-image">
                        <img src="/images/emily2.jpg" alt="Faith-Based Blood Drive" />
                        <div class="event-date-badge">
                            <span class="event-date-day">28</span>
                            <span class="event-date-month">May</span>
                        </div>
