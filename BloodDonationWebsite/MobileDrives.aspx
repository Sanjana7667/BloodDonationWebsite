...
<body>
    ...
    <div class="navbar-content">
        ...
        <div class="container">
            ...
            <div class="filter-section">
               ...
               <button class="filter-button"> <a href="ThisMonth.aspx">This Month</a></button>
                <button class="filter-button"><a href="MobileDrives.aspx">Mobile Drives</a></button>
                <button class="filter-button"><a href="SpecialEvents.aspx">Special Events</a></button>
            </div>
        ...
        <section class="calendar-section">
            <div class="container">
                <h2 class="calendar-title">Stay Up-to-Date with Blood Drives</h2>
                <p>Subscribe to our calendar and never miss an opportunity to donate.</p>
                <a href="#" class="calendar-cta">Add to Calendar</a>
            </div>
        </section>

        <section class="host-section">
            <div class="host-container">
                <h2 class="host-title">Host Your Own Blood Drive</h2>
                <p class="host-description">Partner with us to organize a blood drive at your workplace, school, place of worship, or community center. Our team will provide everything needed for a successful event.</p>
                <a href="#" class="host-cta">Learn More</a>
            </div>
        </section>
             <footer>
